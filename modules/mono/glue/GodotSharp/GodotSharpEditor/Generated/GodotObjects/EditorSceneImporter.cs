...
namespace Godot
{
    public partial class EditorSceneImporter : Reference
    {
        ...
        {
            return EditorNativeCalls.godot_icall_4_398(method_bind_0, Object.GetPtr(this), path, flags, bakeFps, compressFlags);
        }
        ...
        {
            return EditorNativeCalls.godot_icall_3_399(method_bind_1, Object.GetPtr(this), path, flags, bakeFps);
        }
    }
}
