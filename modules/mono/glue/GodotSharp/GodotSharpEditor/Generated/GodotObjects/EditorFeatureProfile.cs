...
namespace Godot
{
    ...
    public partial class EditorFeatureProfile : Reference
    {
        ...
        {
            NativeCalls.godot_icall_2_58(method_bind_0, Object.GetPtr(this), className, disable);
        }
        ...
        {
            return NativeCalls.godot_icall_1_109(method_bind_1, Object.GetPtr(this), className);
        }
        ...
        {
            NativeCalls.godot_icall_2_58(method_bind_2, Object.GetPtr(this), className, disable);
        }
        ...
        {
            return NativeCalls.godot_icall_1_109(method_bind_3, Object.GetPtr(this), className);
        }
        ...
        {
            EditorNativeCalls.godot_icall_3_363(method_bind_4, Object.GetPtr(this), className, property, disable);
        }
        ...
        {
            return NativeCalls.godot_icall_2_117(method_bind_5, Object.GetPtr(this), className, property);
        }
        ...
        {
            return NativeCalls.godot_icall_1_90(method_bind_8, Object.GetPtr(this), (int)feature);
        }
        ...
        /// <summary>
        /// <para>Saves the editor feature profile to a file in JSON format. It can then be imported using the feature profile manager's Import button or the <see cref="Godot.EditorFeatureProfile.LoadFromFile"/> button.</para>
        /// </summary>
