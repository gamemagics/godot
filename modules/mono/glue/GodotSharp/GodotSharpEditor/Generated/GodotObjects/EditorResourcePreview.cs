...
namespace Godot
{
    ...
    public abstract partial class EditorResourcePreview : Node
    {
        ...
        {
            EditorNativeCalls.godot_icall_4_386(method_bind_0, Object.GetPtr(this), path, Object.GetPtr(receiver), receiverFunc, userdata);
        }
        ...
        {
            EditorNativeCalls.godot_icall_4_397(method_bind_1, Object.GetPtr(this), Object.GetPtr(resource), Object.GetPtr(receiver), receiverFunc, userdata);
        }
