...
{
    /// <summary>
    /// <para>EditorSpatialGizmoPlugin allows you to define a new type of Gizmo. There are two main ways to do so: extending <see cref="Godot.EditorSpatialGizmoPlugin"/> for the simpler gizmos, or creating a new <see cref="Godot.EditorSpatialGizmo"/> type. See the tutorial in the documentation for more info.</para>
    /// </summary>
    public partial class EditorSpatialGizmoPlugin : Resource
    {
        ...
        {
            EditorNativeCalls.godot_icall_5_408(method_bind_0, Object.GetPtr(this), name, ref color, billboard, onTop, useVertexColor);
        }
        ...
        public void CreateIconMaterial(string name, Texture texture, bool onTop = false, Nullable<Color> color = null)
        {
            ...
            EditorNativeCalls.godot_icall_4_409(method_bind_1, Object.GetPtr(this), name, Object.GetPtr(texture), onTop, ref color_in);
        }
        ...
        {
            EditorNativeCalls.godot_icall_3_410(method_bind_2, Object.GetPtr(this), name, billboard, Object.GetPtr(texture));
        }
        ...
        {
            NativeCalls.godot_icall_2_115(method_bind_3, Object.GetPtr(this), name, Object.GetPtr(material));
        }
        ...
        {
            return EditorNativeCalls.godot_icall_2_411(method_bind_4, Object.GetPtr(this), name, Object.GetPtr(gizmo));
        }
    }
}
