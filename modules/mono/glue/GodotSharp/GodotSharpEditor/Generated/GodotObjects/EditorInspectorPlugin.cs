...
{
    /// <summary>
    /// <para>These plugins allow adding custom property editors to <see cref="Godot.EditorInspector"/>.</para>
    /// <para>Plugins are registered via <see cref="Godot.EditorPlugin.AddInspectorPlugin"/>.</para>
    ...
    public partial class EditorInspectorPlugin : Reference
    {
        ...
        {
            NativeCalls.godot_icall_1_55(method_bind_0, Object.GetPtr(this), Object.GetPtr(control));
        }
        ...
        {
            NativeCalls.godot_icall_2_371(method_bind_1, Object.GetPtr(this), property, Object.GetPtr(editor));
        }
        ...
        {
            EditorNativeCalls.godot_icall_3_372(method_bind_2, Object.GetPtr(this), label, properties, Object.GetPtr(editor));
        }
    }
}
