...
namespace Godot
{
    ...
    public static partial class InputMap
    {
        ...
        {
            return NativeCalls.godot_icall_1_109(method_bind_0, ptr, action);
        }
        ...
        {
            NativeCalls.godot_icall_2_129(method_bind_2, ptr, action, deadzone);
        }
        ...
        {
            NativeCalls.godot_icall_1_56(method_bind_3, ptr, action);
        }
        ...
        {
            NativeCalls.godot_icall_2_129(method_bind_4, ptr, action, deadzone);
        }
        ...
        {
            return NativeCalls.godot_icall_1_141(method_bind_5, ptr, action);
        }
        ...
        {
            NativeCalls.godot_icall_2_115(method_bind_6, ptr, action, Object.GetPtr(@event));
        }
        ...
        {
            NativeCalls.godot_icall_2_115(method_bind_8, ptr, action, Object.GetPtr(@event));
        }
        ...
        {
            NativeCalls.godot_icall_1_56(method_bind_9, ptr, action);
        }
        ...
        {
            return new Godot.Collections.Array(NativeCalls.godot_icall_1_412(method_bind_10, ptr, action));
        }
        ...
        /// <para>If <c>exact_match</c> is <c>false</c>, it ignores the input modifiers for <see cref="Godot.InputEventKey"/> and <see cref="Godot.InputEventMouseButton"/> events, and the direction for <see cref="Godot.InputEventJoypadMotion"/> events.</para>
        /// </summary>
