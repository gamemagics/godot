...
namespace Godot
{
    ...
    {
        /// <summary>
        /// <para>The layers against which the collision check shall be done. See <a href="https://docs.godotengine.org/en/3.4/tutorials/physics/physics_introduction.html#collision-layers-and-masks">Collision layers and masks</a> in the documentation for more information.</para>
        /// </summary>
...
#pragma warning restore CS0618
        ...
        {
            return NativeCalls.godot_icall_0_297(method_bind_4, Object.GetPtr(this));
        }
        ...
        {
            NativeCalls.godot_icall_1_279(method_bind_5, Object.GetPtr(this), RID.GetPtr(RID));
        }
