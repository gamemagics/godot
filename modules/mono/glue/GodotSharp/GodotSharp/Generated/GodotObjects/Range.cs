...
{
    /// <summary>
    /// <para>Range is a base class for <see cref="Godot.Control"/> nodes that change a floating-point value between a minimum and a maximum, using step and page, for example a <see cref="Godot.ScrollBar"/>.</para>
    /// </summary>
...
#pragma warning restore CS0618
        ...
        {
            NativeCalls.godot_icall_1_55(method_bind_20, Object.GetPtr(this), Object.GetPtr(with));
        }
