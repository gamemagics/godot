...
namespace Godot
{
    ...
    /// <para>Note: Since this node inherits from <see cref="Godot.Node2D"/> (and not <see cref="Godot.Control"/>), anchors and margins won't apply to child <see cref="Godot.Control"/>-derived nodes. This can be problematic when resizing the window. To avoid this, add <see cref="Godot.Control"/>-derived nodes as siblings to the BackBufferCopy node instead of adding them as children.</para>
    /// </summary>
...
#pragma warning restore CS0618
        ...
        /// <summary>
        /// <para>The area covered by the BackBufferCopy. Only used if <see cref="Godot.BackBufferCopy.CopyMode"/> is <see cref="Godot.BackBufferCopy.CopyModeEnum.Rect"/>.</para>
        /// </summary>
        public Rect2 Rect
        {
            get
...
#pragma warning restore CS0618
        ...
        {
            NativeCalls.godot_icall_1_163(method_bind_0, Object.GetPtr(this), ref rect);
        }
        ...
        {
            NativeCalls.godot_icall_0_164(method_bind_1, Object.GetPtr(this), out Rect2 argRet); return (Rect2)argRet;
        }
