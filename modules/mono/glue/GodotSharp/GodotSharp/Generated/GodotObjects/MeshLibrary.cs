...
{
    /// <summary>
    /// <para>A library of meshes. Contains a list of <see cref="Godot.Mesh"/> resources, each with a name and ID. Each item can also include collision and navigation shapes. This resource is used in [GridMap].</para>
    /// </summary>
    public partial class MeshLibrary : Resource
    {
        ...
        {
            NativeCalls.godot_icall_2_122(method_bind_1, Object.GetPtr(this), id, name);
        }
        ...
        {
            NativeCalls.godot_icall_2_60(method_bind_2, Object.GetPtr(this), id, Object.GetPtr(mesh));
        }
        ...
        {
            NativeCalls.godot_icall_2_60(method_bind_4, Object.GetPtr(this), id, Object.GetPtr(navmesh));
        }
        ...
        {
            NativeCalls.godot_icall_2_60(method_bind_7, Object.GetPtr(this), id, Object.GetPtr(texture));
        }
        ...
        {
            return NativeCalls.godot_icall_1_90(method_bind_8, Object.GetPtr(this), id);
        }
        ...
        {
            return NativeCalls.godot_icall_1_61(method_bind_14, Object.GetPtr(this), id);
        }
        ...
        {
            return NativeCalls.godot_icall_1_139(method_bind_16, Object.GetPtr(this), name);
        }
        ...
        {
            return NativeCalls.godot_icall_0_104(method_bind_18, Object.GetPtr(this));
        }
