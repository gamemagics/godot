...
namespace Godot
{
    ...
    public partial class WebRTCPeerConnection : Reference
    {
        ...
        {
            return (Error)NativeCalls.godot_icall_0_383(method_bind_2, Object.GetPtr(this));
        }
        ...
        {
            return (Error)NativeCalls.godot_icall_2_137(method_bind_3, Object.GetPtr(this), type, sdp);
        }
        ...
        {
            return (Error)NativeCalls.godot_icall_2_137(method_bind_4, Object.GetPtr(this), type, sdp);
        }
        ...
        public Error Poll()
        {
            return (Error)NativeCalls.godot_icall_0_383(method_bind_6, Object.GetPtr(this));
        }
