...
namespace Godot
{
    ...
    public static partial class TranslationServer
    {
        ...
        {
            NativeCalls.godot_icall_1_56(method_bind_0, ptr, locale);
        }
        ...
        {
            return NativeCalls.godot_icall_1_125(method_bind_2, ptr, locale);
        }
        ...
        {
            return NativeCalls.godot_icall_1_125(method_bind_3, ptr, message);
        }
