...
namespace Godot
{
    ...
    public abstract partial class VisualScriptLists : VisualScriptNode
    {
        ...
        {
            NativeCalls.godot_icall_3_949(method_bind_0, Object.GetPtr(this), (int)type, name, index);
        }
        ...
        {
            NativeCalls.godot_icall_2_122(method_bind_1, Object.GetPtr(this), index, name);
        }
        ...
        {
            NativeCalls.godot_icall_2_46(method_bind_2, Object.GetPtr(this), index, (int)type);
        }
        ...
        {
            NativeCalls.godot_icall_3_949(method_bind_4, Object.GetPtr(this), (int)type, name, index);
        }
        ...
        {
            NativeCalls.godot_icall_2_122(method_bind_5, Object.GetPtr(this), index, name);
        }
        ...
        {
            NativeCalls.godot_icall_2_46(method_bind_6, Object.GetPtr(this), index, (int)type);
        }
