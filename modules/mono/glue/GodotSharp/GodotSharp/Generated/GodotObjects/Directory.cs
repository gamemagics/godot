...
namespace Godot
{
    ...
    public partial class Directory : Reference
    {
        ...
        /// <summary>
        /// <para>On Windows, returns the name of the drive (partition) passed as an argument (e.g. <c>C:</c>). On other platforms, or if the requested drive does not exist, the method returns an empty String.</para>
        /// </summary>
        ...
        {
            return NativeCalls.godot_icall_1_109(method_bind_12, Object.GetPtr(this), path);
        }
        ...
        {
            return NativeCalls.godot_icall_1_109(method_bind_13, Object.GetPtr(this), path);
        }
        ...
        {
            return (Error)NativeCalls.godot_icall_2_137(method_bind_15, Object.GetPtr(this), from, to);
        }
        ...
        {
            return (Error)NativeCalls.godot_icall_2_137(method_bind_16, Object.GetPtr(this), from, to);
        }
