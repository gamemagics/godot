...
namespace Godot
{
    ...
    /// <para>These effects will only apply when the <see cref="Godot.Viewport"/>'s intended usage is "3D" or "3D Without Effects". This can be configured for the root Viewport with , or for specific Viewports via the <see cref="Godot.Viewport.Usage"/> property.</para>
    /// </summary>
    public partial class Environment : Resource
    {
        ...
        public enum ToneMapper
        {
            ...
            Filmic = 2,
            /// <summary>
            /// <para>Academy Color Encoding System tonemapper operator. Performs an aproximation of the ACES tonemapping curve.</para>
            /// </summary>
            Aces = 3,
            /// <summary>
            /// <para>High quality Academy Color Encoding System tonemapper operator that matches the industry standard. Performs a more physically accurate curve fit which better simulates how light works in the real world. The color of lights and emissive materials will become lighter as the emissive energy increases, and will eventually become white if the light is bright enough to saturate the camera sensor.</para>
            /// </summary>
            AcesFitted = 4
        }
        ...
        public enum SSAOQuality
        {
            ...
            Low = 0,
            /// <summary>
            /// <para>Low quality for the screen-space ambient occlusion effect.</para>
            /// </summary>
            Medium = 1,
            /// <summary>
            /// <para>Low quality for the screen-space ambient occlusion effect (slowest).</para>
            /// </summary>
            High = 2
        }
...
#pragma warning restore CS0618
        ...
        {
            NativeCalls.godot_icall_1_413(method_bind_3, Object.GetPtr(this), ref orientation);
        }
        ...
        {
            NativeCalls.godot_icall_1_149(method_bind_4, Object.GetPtr(this), ref eulerRadians);
        }
        ...
        {
            NativeCalls.godot_icall_1_149(method_bind_5, Object.GetPtr(this), ref eulerDegrees);
        }
        ...
        {
            return (Environment.BGMode)NativeCalls.godot_icall_0_414(method_bind_13, Object.GetPtr(this));
        }
        ...
        {
            return (Environment.ToneMapper)NativeCalls.godot_icall_0_415(method_bind_55, Object.GetPtr(this));
        }
        ...
        {
            return (Environment.SSAOBlur)NativeCalls.godot_icall_0_416(method_bind_101, Object.GetPtr(this));
        }
        ...
        {
            return (Environment.SSAOQuality)NativeCalls.godot_icall_0_417(method_bind_103, Object.GetPtr(this));
        }
        ...
        {
            return (Environment.DOFBlurQuality)NativeCalls.godot_icall_0_418(method_bind_115, Object.GetPtr(this));
        }
        ...
        {
            return (Environment.DOFBlurQuality)NativeCalls.godot_icall_0_418(method_bind_125, Object.GetPtr(this));
        }
        ...
        {
            return (Environment.GlowBlendModeEnum)NativeCalls.godot_icall_0_419(method_bind_137, Object.GetPtr(this));
        }
        ...
        {
            return NativeCalls.godot_icall_0_162(method_bind_157, Object.GetPtr(this));
        }
    }
}
