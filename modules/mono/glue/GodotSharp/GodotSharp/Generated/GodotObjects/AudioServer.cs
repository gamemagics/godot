...
#pragma warning restore CS0618
        ...
        /// <summary>
        /// <para>Name of the current device for audio output (see <see cref="Godot.AudioServer.GetDeviceList"/>).</para>
        /// </summary>
...
#pragma warning restore CS0618
        ...
        {
            NativeCalls.godot_icall_2_46(method_bind_4, ptr, index, toIndex);
        }
        ...
        {
            NativeCalls.godot_icall_2_122(method_bind_5, ptr, busIdx, name);
        }
        ...
        {
            return NativeCalls.godot_icall_1_90(method_bind_6, ptr, busIdx);
        }
        ...
        {
            return NativeCalls.godot_icall_1_139(method_bind_7, ptr, busName);
        }
        ...
        {
            NativeCalls.godot_icall_2_122(method_bind_11, ptr, busIdx, send);
        }
        ...
        {
            return NativeCalls.godot_icall_1_90(method_bind_12, ptr, busIdx);
        }
        ...
        {
            NativeCalls.godot_icall_3_174(method_bind_19, ptr, busIdx, Object.GetPtr(effect), atPosition);
        }
        ...
        {
            NativeCalls.godot_icall_2_46(method_bind_20, ptr, busIdx, effectIdx);
        }
        ...
        {
            return NativeCalls.godot_icall_2_175(method_bind_22, ptr, busIdx, effectIdx);
        }
        ...
        {
            return NativeCalls.godot_icall_3_176(method_bind_23, ptr, busIdx, effectIdx, channel);
        }
        ...
        {
            NativeCalls.godot_icall_3_177(method_bind_24, ptr, busIdx, effectIdx, byEffectIdx);
        }
        ...
        {
            return NativeCalls.godot_icall_2_47(method_bind_26, ptr, busIdx, effectIdx);
        }
        ...
        {
            return NativeCalls.godot_icall_2_71(method_bind_27, ptr, busIdx, channel);
        }
        ...
        {
            return NativeCalls.godot_icall_2_71(method_bind_28, ptr, busIdx, channel);
        }
        ...
        {
            NativeCalls.godot_icall_1_56(method_bind_37, ptr, device);
        }
        ...
        /// <summary>
        /// <para>Name of the current device for audio input (see <see cref="Godot.AudioServer.CaptureGetDeviceList"/>).</para>
        /// </summary>
        ...
        {
            NativeCalls.godot_icall_1_56(method_bind_43, ptr, name);
        }
