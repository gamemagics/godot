...
namespace Godot
{
    ...
    {
        /// <summary>
        /// <para>The physics layer(s) the query will take into account (as a bitmask). See <a href="https://docs.godotengine.org/en/3.4/tutorials/physics/physics_introduction.html#collision-layers-and-masks">Collision layers and masks</a> in the documentation for more information.</para>
        /// </summary>
...
#pragma warning restore CS0618
        ...
        {
            NativeCalls.godot_icall_1_279(method_bind_1, Object.GetPtr(this), RID.GetPtr(shape));
        }
        ...
        {
            NativeCalls.godot_icall_1_219(method_bind_3, Object.GetPtr(this), ref transform);
        }
        ...
        {
            NativeCalls.godot_icall_0_220(method_bind_4, Object.GetPtr(this), out Transform2D argRet); return (Transform2D)argRet;
        }
        ...
        {
            NativeCalls.godot_icall_1_59(method_bind_5, Object.GetPtr(this), ref motion);
        }
        ...
        {
            NativeCalls.godot_icall_1_93(method_bind_11, Object.GetPtr(this), exclude.GetPtr());
        }
