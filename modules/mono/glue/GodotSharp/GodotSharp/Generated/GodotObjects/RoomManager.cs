...
namespace Godot
{
    ...
    public partial class RoomManager : Spatial
    {
        ...
        /// <para>It is important to note that when portal culling is active, it is responsible for all the 3d culling. Some editor functionality may be more difficult to use, so switching the active flag is intended to be used to make sure your <see cref="Godot.Room"/> / <see cref="Godot.Portal"/> layout works within the editor.</para>
...
#pragma warning restore CS0618
        ...
        /// <summary>
        /// <para>Portal culling normally operates using the current <see cref="Godot.Camera"/> / <see cref="Godot.Camera"/>s, however for debugging purposes within the editor, you can use this setting to override this behaviour and force it to use a particular camera to get a better idea of what the occlusion culling is doing.</para>
        /// </summary>
...
#pragma warning restore CS0618
        ...
        {
            NativeCalls.godot_icall_1_130(method_bind_4, Object.GetPtr(this), NodePath.GetPtr(pPath));
        }
        ...
        {
            return new NodePath(NativeCalls.godot_icall_0_131(method_bind_5, Object.GetPtr(this)));
        }
        ...
        {
            NativeCalls.godot_icall_1_130(method_bind_20, Object.GetPtr(this), NodePath.GetPtr(previewCamera));
        }
        ...
        {
            return new NodePath(NativeCalls.godot_icall_0_131(method_bind_21, Object.GetPtr(this)));
        }
