...
namespace Godot
{
    ...
    public partial class AStar2D : Reference
    {
        ...
        /// <summary>
        /// <para>Adds a new point at the given position with the given identifier. The <c>id</c> must be 0 or larger, and the <c>weight_scale</c> must be 1 or larger.</para>
        ...
        {
            NativeCalls.godot_icall_2_46(method_bind_13, Object.GetPtr(this), id, toId);
        }
        ...
        {
            return NativeCalls.godot_icall_2_47(method_bind_14, Object.GetPtr(this), id, toId);
        }
        ...
        {
            return NativeCalls.godot_icall_2_48(method_bind_19, Object.GetPtr(this), ref toPosition, includeDisabled);
        }
        ...
        {
            NativeCalls.godot_icall_1_49(method_bind_20, Object.GetPtr(this), ref toPosition, out Vector2 argRet); return (Vector2)argRet;
        }
        ...
        {
            return NativeCalls.godot_icall_2_50(method_bind_21, Object.GetPtr(this), fromId, toId);
        }
