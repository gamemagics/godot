...
#pragma warning restore CS0618
        ...
        /// <summary>
        /// <para>Turn on auto advance when this condition is set. The provided name will become a boolean parameter on the <see cref="Godot.AnimationTree"/> that can be controlled from code (see <a href="https://docs.godotengine.org/en/3.4/tutorials/animation/animation_tree.html#controlling-from-code"></a>). For example, if <see cref="Godot.AnimationTree.TreeRoot"/> is an <see cref="Godot.AnimationNodeStateMachine"/> and <see cref="Godot.AnimationNodeStateMachineTransition.AdvanceCondition"/> is set to <c>"idle"</c>:</para>
        /// <para><code>
...
#pragma warning restore CS0618
        ...
        {
            return (AnimationNodeStateMachineTransition.SwitchModeEnum)NativeCalls.godot_icall_0_121(method_bind_1, Object.GetPtr(this));
        }
        ...
        {
            NativeCalls.godot_icall_1_56(method_bind_4, Object.GetPtr(this), name);
        }
