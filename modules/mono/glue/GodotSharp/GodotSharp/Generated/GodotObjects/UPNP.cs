...
{
    /// <summary>
    /// <para>Provides UPNP functionality to discover <see cref="Godot.UPNPDevice"/>s on the local network and execute commands on them, like managing port mappings (port forwarding) and querying the local and remote network IP address. Note that methods on this class are synchronous and block the calling thread.</para>
...
#pragma warning restore CS0618
        ...
        {
            return NativeCalls.godot_icall_1_936(method_bind_1, Object.GetPtr(this), index);
        }
        ...
        {
            NativeCalls.godot_icall_2_60(method_bind_3, Object.GetPtr(this), index, Object.GetPtr(device));
        }
        ...
        {
            return NativeCalls.godot_icall_0_937(method_bind_6, Object.GetPtr(this));
        }
        ...
        {
            return NativeCalls.godot_icall_3_938(method_bind_7, Object.GetPtr(this), timeout, ttl, deviceFilter);
        }
        ...
        /// <summary>
        /// <para>Adds a mapping to forward the external <c>port</c> (between 1 and 65535) on the default gateway (see <see cref="Godot.UPNP.GetGateway"/>) to the <c>internal_port</c> on the local machine for the given protocol <c>proto</c> (either <c>TCP</c> or <c>UDP</c>, with UDP being the default). If a port mapping for the given port and protocol combination already exists on that gateway device, this method tries to overwrite it. If that is not desired, you can retrieve the gateway manually with <see cref="Godot.UPNP.GetGateway"/> and call <see cref="Godot.UPNP.AddPortMapping"/> on it, if any.</para>
        ...
        {
            return NativeCalls.godot_icall_5_939(method_bind_9, Object.GetPtr(this), port, portInternal, desc, proto, duration);
        }
        ...
        {
            NativeCalls.godot_icall_1_56(method_bind_11, Object.GetPtr(this), mIf);
        }
