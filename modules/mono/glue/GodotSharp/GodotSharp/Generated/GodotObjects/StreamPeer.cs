...
#pragma warning restore CS0618
        ...
        {
            NativeCalls.godot_icall_1_277(method_bind_14, Object.GetPtr(this), value);
        }
        ...
        {
            NativeCalls.godot_icall_1_56(method_bind_17, Object.GetPtr(this), value);
        }
        ...
        {
            NativeCalls.godot_icall_1_56(method_bind_18, Object.GetPtr(this), value);
        }
        ...
        public long Get64()
        {
            return NativeCalls.godot_icall_0_166(method_bind_26, Object.GetPtr(this));
        }
        ...
        /// <summary>
        /// <para>Gets a string with byte-length <c>bytes</c> from the stream. If <c>bytes</c> is negative (default) the length will be read from the stream using the reverse process of <see cref="Godot.StreamPeer.PutString"/>.</para>
        /// </summary>
        [GodotMethod("get_string")]
        public string GetString(int bytes = -1)
        {
            return NativeCalls.godot_icall_1_90(method_bind_30, Object.GetPtr(this), bytes);
        }
        ...
        {
            return NativeCalls.godot_icall_1_90(method_bind_31, Object.GetPtr(this), bytes);
        }
