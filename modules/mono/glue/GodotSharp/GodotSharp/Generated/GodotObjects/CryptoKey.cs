...
namespace Godot
{
    ...
    public partial class CryptoKey : Resource
    {
        ...
        {
            return (Error)NativeCalls.godot_icall_2_331(method_bind_0, Object.GetPtr(this), path, publicOnly);
        }
        ...
        {
            return (Error)NativeCalls.godot_icall_2_331(method_bind_1, Object.GetPtr(this), path, publicOnly);
        }
        ...
        {
            return NativeCalls.godot_icall_1_332(method_bind_3, Object.GetPtr(this), publicOnly);
        }
        ...
        {
            return (Error)NativeCalls.godot_icall_2_331(method_bind_4, Object.GetPtr(this), stringKey, publicOnly);
        }
    }
}
