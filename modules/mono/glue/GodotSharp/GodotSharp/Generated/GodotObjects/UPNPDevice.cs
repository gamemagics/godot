...
{
    /// <summary>
    /// <para>UPNP device. See <see cref="Godot.UPNP"/> for UPNP discovery and utility functions. Provides low-level access to UPNP control commands. Allows to manage port mappings (port forwarding) and to query network information of the device (like local and external IP address and status). Note that methods on this class are synchronous and block the calling thread.</para>
    /// </summary>
...
#pragma warning restore CS0618
        ...
        {
            return NativeCalls.godot_icall_5_939(method_bind_2, Object.GetPtr(this), port, portInternal, desc, proto, duration);
        }
        ...
        {
            return NativeCalls.godot_icall_2_940(method_bind_3, Object.GetPtr(this), port, proto);
        }
        ...
        {
            NativeCalls.godot_icall_1_56(method_bind_4, Object.GetPtr(this), url);
        }
        ...
        {
            NativeCalls.godot_icall_1_56(method_bind_6, Object.GetPtr(this), type);
        }
        ...
        {
            NativeCalls.godot_icall_1_56(method_bind_8, Object.GetPtr(this), url);
        }
        ...
        {
            NativeCalls.godot_icall_1_56(method_bind_12, Object.GetPtr(this), addr);
        }
        ...
        {
            return (UPNPDevice.IGDStatus)NativeCalls.godot_icall_0_941(method_bind_15, Object.GetPtr(this));
        }
    }
}
