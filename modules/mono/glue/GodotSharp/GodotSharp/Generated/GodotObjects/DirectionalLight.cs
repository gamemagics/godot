...
#pragma warning restore CS0618
        ...
        /// <summary>
        /// <para>The distance from camera to shadow split 1. Relative to <see cref="Godot.DirectionalLight.DirectionalShadowMaxDistance"/>. Only used when <see cref="Godot.DirectionalLight.DirectionalShadowMode"/> is <c>SHADOW_PARALLEL_2_SPLITS</c> or <c>SHADOW_PARALLEL_4_SPLITS</c>.</para>
        /// </summary>
...
#pragma warning restore CS0618
        ...
        /// <summary>
        /// <para>The distance from shadow split 1 to split 2. Relative to <see cref="Godot.DirectionalLight.DirectionalShadowMaxDistance"/>. Only used when <see cref="Godot.DirectionalLight.DirectionalShadowMode"/> is <c>SHADOW_PARALLEL_2_SPLITS</c> or <c>SHADOW_PARALLEL_4_SPLITS</c>.</para>
        /// </summary>
...
#pragma warning restore CS0618
        ...
        /// <summary>
        /// <para>Amount of extra bias for shadow splits that are far away. If self-shadowing occurs only on the splits far away, increasing this value can fix them.</para>
        /// </summary>
...
#pragma warning restore CS0618
        ...
        {
            return (DirectionalLight.ShadowMode)NativeCalls.godot_icall_0_356(method_bind_1, Object.GetPtr(this));
        }
        ...
        {
            return (DirectionalLight.ShadowDepthRange)NativeCalls.godot_icall_0_357(method_bind_3, Object.GetPtr(this));
        }
