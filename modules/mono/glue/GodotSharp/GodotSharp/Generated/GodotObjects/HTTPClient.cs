...
{
    /// <summary>
    /// <para>Hyper-text transfer protocol client (sometimes called "User Agent"). Used to make HTTP requests to download web content, upload files and other data or to communicate with various services, among other use cases. See the <see cref="Godot.HTTPRequest"/> node for a higher-level alternative.</para>
...
#pragma warning restore CS0618
        ...
        {
            return NativeCalls.godot_icall_0_120(method_bind_9, Object.GetPtr(this));
        }
        ...
        public Error Poll()
        {
            return (Error)NativeCalls.godot_icall_0_383(method_bind_18, Object.GetPtr(this));
        }

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private static IntPtr method_bind_19 = Object.godot_icall_Object_ClassDB_get_method(nativeName, "query_string_from_dict");
