...
{
    /// <summary>
    /// <para>Node used for displaying a <see cref="Godot.Mesh"/> in 2D. Can be constructed from an existing <see cref="Godot.Sprite"/> via a tool in the editor toolbar. Select "Sprite" then "Convert to Mesh2D", select settings in popup and press "Create Mesh2D".</para>
    /// </summary>
