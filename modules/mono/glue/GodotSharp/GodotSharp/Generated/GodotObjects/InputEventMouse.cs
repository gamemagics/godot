...
#pragma warning restore CS0618
        ...
        /// <summary>
        /// <para>The local mouse position relative to the <see cref="Godot.Viewport"/>. If used in <see cref="Godot.Control._GuiInput"/>, the position is relative to the current <see cref="Godot.Control"/> which is under the mouse.</para>
        /// </summary>
...
#pragma warning restore CS0618
        ...
        /// <summary>
        /// <para>The global mouse position relative to the current <see cref="Godot.Viewport"/> when used in <see cref="Godot.Control._GuiInput"/>, otherwise is at 0,0.</para>
        /// </summary>
...
#pragma warning restore CS0618
        ...
        {
            NativeCalls.godot_icall_1_59(method_bind_2, Object.GetPtr(this), ref position);
        }
        ...
        {
            NativeCalls.godot_icall_1_59(method_bind_4, Object.GetPtr(this), ref globalPosition);
        }
