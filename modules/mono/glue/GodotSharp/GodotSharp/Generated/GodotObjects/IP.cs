...
namespace Godot
{
    ...
    public static partial class IP
    {
        ...
        /// </summary>
        public const int ResolverMaxQueries = 32;
        /// <summary>
        ...
        {
            return NativeCalls.godot_icall_2_140(method_bind_0, ptr, host, (int)ipType);
        }
        ...
        {
            return NativeCalls.godot_icall_1_90(method_bind_4, ptr, id);
        }
        ...
        {
            NativeCalls.godot_icall_1_56(method_bind_9, ptr, hostname);
        }
    }
}
