...
namespace Godot
{
    ...
    {
        /// <summary>
        /// <para><see cref="Godot.Texture"/> object to draw. If <see cref="Godot.GeometryInstance.MaterialOverride"/> is used, this will be overridden.</para>
        /// </summary>
...
#pragma warning restore CS0618
        ...
        {
            NativeCalls.godot_icall_1_163(method_bind_4, Object.GetPtr(this), ref rect);
        }
        ...
        {
            NativeCalls.godot_icall_0_164(method_bind_5, Object.GetPtr(this), out Rect2 argRet); return (Rect2)argRet;
        }
        ...
        {
            NativeCalls.godot_icall_1_59(method_bind_8, Object.GetPtr(this), ref coords);
        }
