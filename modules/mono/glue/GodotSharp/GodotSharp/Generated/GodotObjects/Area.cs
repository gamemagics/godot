...
{
    /// <summary>
    /// <para>3D area that detects <see cref="Godot.CollisionObject"/> nodes overlapping, entering, or exiting. Can also alter or override local physics parameters (gravity, damping) and route audio to custom audio buses.</para>
    /// </summary>
...
#pragma warning restore CS0618
        ...
        {
            return (Area.SpaceOverrideEnum)NativeCalls.godot_icall_0_148(method_bind_1, Object.GetPtr(this));
        }
        ...
        {
            NativeCalls.godot_icall_1_149(method_bind_6, Object.GetPtr(this), ref vector);
        }
        ...
        /// <para>The <c>body</c> argument can either be a <see cref="Godot.PhysicsBody"/> or a [GridMap] instance (while GridMaps are not physics body themselves, they register their tiles with collision shapes as a virtual physics body).</para>
        /// </summary>
        [GodotMethod("overlaps_body")]
        public bool OverlapsBody(Node body)
        {
            return NativeCalls.godot_icall_1_150(method_bind_22, Object.GetPtr(this), Object.GetPtr(body));
        }
        ...
        {
            return NativeCalls.godot_icall_1_150(method_bind_23, Object.GetPtr(this), Object.GetPtr(area));
        }
        ...
        {
            NativeCalls.godot_icall_1_56(method_bind_26, Object.GetPtr(this), name);
        }
        ...
        {
            NativeCalls.godot_icall_1_56(method_bind_30, Object.GetPtr(this), name);
        }
