...
namespace Godot
{
    ...
    public static partial class CameraServer
    {
        public enum FeedImage
        {
            ...
            RgbaImage = 0,
            /// <summary>
            /// <para>The YCbCr camera image.</para>
            /// </summary>
            YcbcrImage = 0,
            /// <summary>
        ...
        /// <summary>
        /// <para>Returns the <see cref="Godot.CameraFeed"/> with this id.</para>
        /// </summary>
        [GodotMethod("get_feed")]
        public static CameraFeed GetFeed(int index)
        {
            return NativeCalls.godot_icall_1_252(method_bind_0, ptr, index);
        }
        ...
        /// <summary>
        /// <para>Adds a camera feed to the camera server.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Removes a <see cref="Godot.CameraFeed"/>.</para>
        /// </summary>
