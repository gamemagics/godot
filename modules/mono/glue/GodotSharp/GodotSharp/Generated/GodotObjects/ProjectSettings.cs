...
namespace Godot
{
    ...
    /// <para>Feature tags: Project settings can be overridden for specific platforms and configurations (debug, release, ...) using <a href="https://docs.godotengine.org/en/3.4/tutorials/export/feature_tags.html">feature tags</a>.</para>
    /// <para>Overriding: Any project setting can be overridden by creating a file named <c>override.cfg</c> in the project's root directory. This can also be used in exported projects by placing this file in the same directory as the project binary. Overriding will still take the base project settings' <a href="https://docs.godotengine.org/en/3.4/tutorials/export/feature_tags.html">feature tags</a> in account. Therefore, make sure to also override the setting with the desired feature tags if you want them to override base project settings on all platforms and configurations.</para>
    /// </summary>
    public static partial class ProjectSettings
    {
        ...
        {
            return NativeCalls.godot_icall_1_109(method_bind_0, ptr, name);
        }
        ...
        {
            NativeCalls.godot_icall_2_97(method_bind_1, ptr, name, value);
        }
        ...
        {
            return NativeCalls.godot_icall_1_98(method_bind_2, ptr, name);
        }
        ...
        {
            NativeCalls.godot_icall_2_111(method_bind_3, ptr, name, position);
        }
        ...
        {
            return NativeCalls.godot_icall_1_139(method_bind_4, ptr, name);
        }
        ...
        {
            NativeCalls.godot_icall_2_97(method_bind_5, ptr, name, value);
        }
        ...
        {
            NativeCalls.godot_icall_1_56(method_bind_7, ptr, name);
        }
        ...
        {
            return NativeCalls.godot_icall_1_125(method_bind_8, ptr, path);
        }
        ...
        {
            return NativeCalls.godot_icall_1_125(method_bind_9, ptr, path);
        }
        ...
        {
            return (Error)NativeCalls.godot_icall_0_383(method_bind_10, ptr);
        }
        ...
        {
            return NativeCalls.godot_icall_1_109(method_bind_12, ptr, name);
        }
        ...
        {
            return NativeCalls.godot_icall_1_98(method_bind_13, ptr, name);
        }
