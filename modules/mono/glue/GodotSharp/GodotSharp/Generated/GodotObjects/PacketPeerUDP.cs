...
namespace Godot
{
    ...
    public partial class PacketPeerUDP : PacketPeer
    {
        ...
        {
            return (Error)NativeCalls.godot_icall_2_137(method_bind_10, Object.GetPtr(this), multicastAddress, interfaceName);
        }
        ...
        {
            return (Error)NativeCalls.godot_icall_2_137(method_bind_11, Object.GetPtr(this), multicastAddress, interfaceName);
        }
    }
}
