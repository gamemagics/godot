...
#pragma warning restore CS0618
        ...
        /// <summary>
        /// <para>Gets a child node by index (used by editors inheriting from <see cref="Godot.AnimationRootNode"/>).</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Gets all children nodes in order as a <c>name: node</c> dictionary. Only useful when inheriting <see cref="Godot.AnimationRootNode"/>.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Gets the property information for parameter. Parameters are custom local memory used for your nodes, given a resource can be reused in multiple trees. Format is similar to <see cref="Godot.Object.GetPropertyList"/>.</para>
        /// </summary>
        ...
        {
            return NativeCalls.godot_icall_1_90(method_bind_1, Object.GetPtr(this), input);
        }
        ...
        {
            NativeCalls.godot_icall_2_91(method_bind_4, Object.GetPtr(this), NodePath.GetPtr(path), enable);
        }
        ...
        {
            return NativeCalls.godot_icall_1_92(method_bind_5, Object.GetPtr(this), NodePath.GetPtr(path));
        }
        ...
        {
            NativeCalls.godot_icall_1_93(method_bind_8, Object.GetPtr(this), filters.GetPtr());
        }
        ...
        {
            NativeCalls.godot_icall_5_94(method_bind_10, Object.GetPtr(this), animation, time, delta, seeked, blend);
        }
        ...
        {
            return NativeCalls.godot_icall_7_95(method_bind_11, Object.GetPtr(this), name, Object.GetPtr(node), time, seek, blend, (int)filter, optimize);
        }
        ...
        {
            return NativeCalls.godot_icall_6_96(method_bind_12, Object.GetPtr(this), inputIndex, time, seek, blend, (int)filter, optimize);
        }
        ...
        {
            NativeCalls.godot_icall_2_97(method_bind_13, Object.GetPtr(this), name, value);
        }
