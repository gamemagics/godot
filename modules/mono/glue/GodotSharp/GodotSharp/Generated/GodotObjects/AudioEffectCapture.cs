...
namespace Godot
{
    ...
    /// <para>Application code should consume these audio frames from this ring buffer using <see cref="Godot.AudioEffectCapture.GetBuffer"/> and process it as needed, for example to capture data from a microphone, implement application defined effects, or to transmit audio over the network.</para>
    /// </summary>
...
#pragma warning restore CS0618
        ...
        {
            return NativeCalls.godot_icall_1_165(method_bind_1, Object.GetPtr(this), frames);
        }
        ...
        {
            return NativeCalls.godot_icall_0_166(method_bind_6, Object.GetPtr(this));
        }
        ...
        {
            return NativeCalls.godot_icall_0_166(method_bind_8, Object.GetPtr(this));
        }
    }
}
