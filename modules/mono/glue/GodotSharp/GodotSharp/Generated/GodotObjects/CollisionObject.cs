...
#pragma warning restore CS0618
        ...
        /// <summary>
        /// <para>If <c>true</c>, the <see cref="Godot.CollisionObject"/>'s shapes will respond to <see cref="Godot.RayCast"/>s.</para>
        /// </summary>
...
#pragma warning restore CS0618
        ...
        /// <summary>
        /// <para>If <c>value</c> is <c>true</c>, sets the specified <c>bit</c> in the the <see cref="Godot.CollisionObject.CollisionLayer"/>.</para>
        /// <para>If <c>value</c> is <c>false</c>, clears the specified <c>bit</c> in the the <see cref="Godot.CollisionObject.CollisionLayer"/>.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>If <c>value</c> is <c>true</c>, sets the specified <c>bit</c> in the the <see cref="Godot.CollisionObject.CollisionMask"/>.</para>
        /// <para>If <c>value</c> is <c>false</c>, clears the specified <c>bit</c> in the the <see cref="Godot.CollisionObject.CollisionMask"/>.</para>
        /// </summary>
        ...
        public RID GetRid()
        {
            return new RID(NativeCalls.godot_icall_0_247(method_bind_12, Object.GetPtr(this)));
        }
        ...
        {
            return NativeCalls.godot_icall_1_280(method_bind_13, Object.GetPtr(this), Object.GetPtr(owner));
        }
        ...
        {
            NativeCalls.godot_icall_2_281(method_bind_16, Object.GetPtr(this), ownerId, ref transform);
        }
        ...
        {
            NativeCalls.godot_icall_1_282(method_bind_17, Object.GetPtr(this), ownerId, out Transform argRet); return (Transform)argRet;
        }
        ...
        {
            return NativeCalls.godot_icall_1_283(method_bind_18, Object.GetPtr(this), ownerId);
        }
        ...
        {
            NativeCalls.godot_icall_2_284(method_bind_19, Object.GetPtr(this), ownerId, disabled);
        }
        ...
        {
            NativeCalls.godot_icall_2_286(method_bind_21, Object.GetPtr(this), ownerId, Object.GetPtr(shape));
        }
        ...
        {
            return NativeCalls.godot_icall_1_287(method_bind_22, Object.GetPtr(this), ownerId);
        }
        ...
        {
            return NativeCalls.godot_icall_2_288(method_bind_23, Object.GetPtr(this), ownerId, shapeId);
        }
        ...
        {
            return NativeCalls.godot_icall_2_289(method_bind_24, Object.GetPtr(this), ownerId, shapeId);
        }
        ...
        {
            NativeCalls.godot_icall_2_290(method_bind_25, Object.GetPtr(this), ownerId, shapeId);
        }
        ...
        {
            return NativeCalls.godot_icall_1_155(method_bind_27, Object.GetPtr(this), shapeIndex);
        }
    }
}
