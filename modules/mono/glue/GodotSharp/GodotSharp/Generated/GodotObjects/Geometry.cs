...
namespace Godot
{
    ...
    public static partial class Geometry
    {
        ...
        /// <summary>
        /// <para>Checks if the two segments (<c>from_a</c>, <c>to_a</c>) and (<c>from_b</c>, <c>to_b</c>) intersect. If yes, return the point of intersection as <see cref="Godot.Vector2"/>. If no intersection takes place, returns an empty <c>Variant</c>.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Checks if the two lines (<c>from_a</c>, <c>dir_a</c>) and (<c>from_b</c>, <c>dir_b</c>) intersect. If yes, return the point of intersection as <see cref="Godot.Vector2"/>. If no intersection takes place, returns an empty <c>Variant</c>.</para>
        ...
        /// <summary>
        /// <para>Given an array of <see cref="Godot.Vector2"/>s representing tiles, builds an atlas. The returned dictionary has two keys: <c>points</c> is a vector of <see cref="Godot.Vector2"/> that specifies the positions of each tile, <c>size</c> contains the overall size of the whole atlas as <see cref="Godot.Vector2"/>.</para>
        /// </summary>
