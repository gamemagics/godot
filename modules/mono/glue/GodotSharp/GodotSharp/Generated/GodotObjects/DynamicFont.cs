...
namespace Godot
{
    ...
    /// <para>DynamicFont uses the <a href="https://www.freetype.org/">FreeType</a> library for rasterization. Supported formats are TrueType (<c>.ttf</c>), OpenType (<c>.otf</c>) and Web Open Font Format 1 (<c>.woff</c>). Web Open Font Format 2 (<c>.woff2</c>) is not supported.</para>
    /// <para><code>
...
#pragma warning restore CS0618
        ...
        {
            return NativeCalls.godot_icall_0_358(method_bind_1, Object.GetPtr(this));
        }
        ...
        {
            NativeCalls.godot_icall_2_46(method_bind_13, Object.GetPtr(this), type, value);
        }
        ...
        {
            NativeCalls.godot_icall_2_60(method_bind_16, Object.GetPtr(this), idx, Object.GetPtr(data));
        }
        ...
        {
            return NativeCalls.godot_icall_1_359(method_bind_17, Object.GetPtr(this), idx);
        }
