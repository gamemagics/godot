...
namespace Godot
{
    ...
    public abstract partial class PhysicsBody : CollisionObject
    {
        ...
        {
            NativeCalls.godot_icall_1_55(method_bind_1, Object.GetPtr(this), Object.GetPtr(body));
        }
        ...
        {
            NativeCalls.godot_icall_1_55(method_bind_2, Object.GetPtr(this), Object.GetPtr(body));
        }
    }
}
