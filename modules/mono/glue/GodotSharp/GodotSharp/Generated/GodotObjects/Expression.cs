...
namespace Godot
{
    ...
    public partial class Expression : Reference
    {
        ...
        public Error Parse(string expression, string[] inputNames = null)
        {
            ...
            return (Error)NativeCalls.godot_icall_2_420(method_bind_0, Object.GetPtr(this), expression, inputNames_in);
        }
        ...
        public object Execute(Godot.Collections.Array inputs = null, Object baseInstance = null, bool showError = true)
        {
            ...
            return NativeCalls.godot_icall_3_421(method_bind_1, Object.GetPtr(this), inputs_in.GetPtr(), Object.GetPtr(baseInstance), showError);
        }
