...
namespace Godot
{
    ...
    {
        /// <summary>
        /// <para>Width of the height map data. Changing this will resize the <see cref="Godot.HeightMapShape.MapData"/>.</para>
        /// </summary>
        public int MapWidth
        {
            get
...
#pragma warning restore CS0618
        ...
        /// <summary>
        /// <para>Depth of the height map data. Changing this will resize the <see cref="Godot.HeightMapShape.MapData"/>.</para>
        /// </summary>
        public int MapDepth
        {
            get
...
#pragma warning restore CS0618
        ...
        {
            return NativeCalls.godot_icall_0_350(method_bind_5, Object.GetPtr(this));
        }
    }
}
