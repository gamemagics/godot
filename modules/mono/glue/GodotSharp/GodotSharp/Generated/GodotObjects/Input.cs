...
namespace Godot
{
    ...
    public static partial class Input
    {
        ...
        /// <summary>
        /// <para>Returns <c>true</c> if you are pressing the key. You can pass a <see cref="Godot.KeyList"/> constant.</para>
        /// </summary>
        ...
        {
            return NativeCalls.godot_icall_2_47(method_bind_3, ptr, device, button);
        }
        ...
        /// <para>If <c>exact</c> is <c>false</c>, it ignores the input modifiers for <see cref="Godot.InputEventKey"/> and <see cref="Godot.InputEventMouseButton"/> events, and the direction for <see cref="Godot.InputEventJoypadMotion"/> events.</para>
        /// </summary>
        ...
        {
            return NativeCalls.godot_icall_2_127(method_bind_9, ptr, negativeAction, positiveAction);
        }
        ...
        {
            NativeCalls.godot_icall_2_58(method_bind_11, ptr, mapping, updateExisting);
        }
        ...
        {
            NativeCalls.godot_icall_1_56(method_bind_12, ptr, guid);
        }
        ...
        {
            return NativeCalls.godot_icall_2_71(method_bind_15, ptr, device, axis);
        }
        ...
        {
            return NativeCalls.godot_icall_1_90(method_bind_16, ptr, device);
        }
        ...
        {
            return NativeCalls.godot_icall_1_90(method_bind_17, ptr, device);
        }
        ...
        {
            return NativeCalls.godot_icall_1_90(method_bind_21, ptr, buttonIndex);
        }
        ...
        {
            return NativeCalls.godot_icall_1_139(method_bind_22, ptr, button);
        }
        ...
        {
            return NativeCalls.godot_icall_1_90(method_bind_23, ptr, axisIndex);
        }
        ...
        {
            return NativeCalls.godot_icall_1_139(method_bind_24, ptr, axis);
        }
        ...
        {
            NativeCalls.godot_icall_1_149(method_bind_32, ptr, ref value);
        }
        ...
        {
            NativeCalls.godot_icall_1_149(method_bind_33, ptr, ref value);
        }
        ...
        {
            NativeCalls.godot_icall_1_149(method_bind_34, ptr, ref value);
        }
        ...
        {
            NativeCalls.godot_icall_1_149(method_bind_35, ptr, ref value);
        }
        ...
        {
            NativeCalls.godot_icall_1_59(method_bind_40, ptr, ref to);
        }
        ...
        {
            NativeCalls.godot_icall_2_129(method_bind_41, ptr, action, strength);
        }
        ...
        {
            NativeCalls.godot_icall_1_56(method_bind_42, ptr, action);
        }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private static IntPtr method_bind_48 = Object.godot_icall_Object_ClassDB_get_method(nativeName, "flush_buffered_events");

        /// <summary>
        /// <para>Sends all input events which are in the current buffer to the game loop. These events may have been buffered as a result of accumulated input (<see cref="Godot.Input.SetUseAccumulatedInput"/>) or agile input flushing ().</para>
