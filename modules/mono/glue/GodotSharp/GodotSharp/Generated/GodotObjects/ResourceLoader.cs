...
namespace Godot
{
    ...
    public static partial class ResourceLoader
    {
        ...
        {
            return NativeCalls.godot_icall_1_303(method_bind_2, ptr, type);
        }
        ...
        {
            return NativeCalls.godot_icall_1_303(method_bind_4, ptr, path);
        }
        ...
        {
            return NativeCalls.godot_icall_1_109(method_bind_5, ptr, path);
        }
        ...
        {
            return NativeCalls.godot_icall_2_117(method_bind_6, ptr, path, typeHint);
        }
        ...
        {
            return NativeCalls.godot_icall_1_109(method_bind_7, ptr, path);
        }
    }
}
