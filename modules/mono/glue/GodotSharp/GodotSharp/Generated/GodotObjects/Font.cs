...
namespace Godot
{
    ...
    public abstract partial class Font : Resource
    {
        ...
        public void Draw(RID canvasItem, Vector2 position, string @string, Nullable<Color> modulate = null, int clipW = -1, Nullable<Color> outlineModulate = null)
        {
            ...
            NativeCalls.godot_icall_6_425(method_bind_0, Object.GetPtr(this), RID.GetPtr(canvasItem), ref position, @string, ref modulate_in, clipW, ref outlineModulate_in);
        }
        ...
        {
            NativeCalls.godot_icall_2_83(method_bind_5, Object.GetPtr(this), @char, next, out Vector2 argRet); return (Vector2)argRet;
        }
        ...
        {
            NativeCalls.godot_icall_1_113(method_bind_6, Object.GetPtr(this), @string, out Vector2 argRet); return (Vector2)argRet;
        }
        ...
        {
            NativeCalls.godot_icall_2_426(method_bind_7, Object.GetPtr(this), @string, width, out Vector2 argRet); return (Vector2)argRet;
        }
        ...
        {
            Color modulate_in = modulate.HasValue ? modulate.Value : new Color(1, 1, 1, 1);
            return NativeCalls.godot_icall_6_427(method_bind_9, Object.GetPtr(this), RID.GetPtr(canvasItem), ref position, @char, next, ref modulate_in, outline);
        }

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private static IntPtr method_bind_10 = Object.godot_icall_Object_ClassDB_get_method(nativeName, "update_changes");
