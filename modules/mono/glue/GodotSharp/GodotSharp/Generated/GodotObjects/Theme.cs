...
#pragma warning restore CS0618
        ...
        /// <summary>
        /// <para>Sets the theme's icon <see cref="Godot.Texture"/> to <c>texture</c> at <c>name</c> in <c>node_type</c>.</para>
        /// <para>Creates <c>node_type</c> if the theme does not have it.</para>
        /// </summary>
        [GodotMethod("set_icon")]
        public void SetIcon(string name, string nodeType, Texture texture)
        {
            NativeCalls.godot_icall_3_118(method_bind_0, Object.GetPtr(this), name, nodeType, Object.GetPtr(texture));
        }
        ...
        /// <summary>
        /// <para>Returns the icon <see cref="Godot.Texture"/> at <c>name</c> if the theme has <c>node_type</c>.</para>
        /// </summary>
        [GodotMethod("get_icon")]
        public Texture GetIcon(string name, string nodeType)
        {
            return NativeCalls.godot_icall_2_311(method_bind_1, Object.GetPtr(this), name, nodeType);
        }
        ...
        /// <summary>
        /// <para>Returns <c>true</c> if icon <see cref="Godot.Texture"/> with <c>name</c> is in <c>node_type</c>.</para>
        /// <para>Returns <c>false</c> if the theme does not have <c>node_type</c>.</para>
        /// </summary>
        [GodotMethod("has_icon")]
        public bool HasIcon(string name, string nodeType)
        {
            return NativeCalls.godot_icall_2_117(method_bind_2, Object.GetPtr(this), name, nodeType);
        }
        ...
        /// <summary>
        /// <para>Renames the icon at <c>old_name</c> to <c>name</c> if the theme has <c>node_type</c>. If <c>name</c> is already taken, this method fails.</para>
        /// </summary>
        ...
        public void ClearIcon(string name, string nodeType)
        {
            NativeCalls.godot_icall_2_108(method_bind_4, Object.GetPtr(this), name, nodeType);
        }
        ...
        /// <summary>
        /// <para>Returns all the icons as a <see cref="string"/> filled with each <see cref="Godot.Texture"/>'s name, for use in <see cref="Godot.Theme.GetIcon"/>, if the theme has <c>node_type</c>.</para>
        /// </summary>
        [GodotMethod("get_icon_list")]
        public string[] GetIconList(string nodeType)
        {
            return NativeCalls.godot_icall_1_303(method_bind_5, Object.GetPtr(this), nodeType);
        }
        ...
        {
            return NativeCalls.godot_icall_0_120(method_bind_6, Object.GetPtr(this));
        }
        ...
        /// <summary>
        /// <para>Sets theme's <see cref="Godot.StyleBox"/> to <c>stylebox</c> at <c>name</c> in <c>node_type</c>.</para>
        /// <para>Creates <c>node_type</c> if the theme does not have it.</para>
        /// </summary>
        [GodotMethod("set_stylebox")]
        public void SetStylebox(string name, string nodeType, StyleBox texture)
        {
            NativeCalls.godot_icall_3_118(method_bind_7, Object.GetPtr(this), name, nodeType, Object.GetPtr(texture));
        }
        ...
        /// <summary>
        /// <para>Returns the <see cref="Godot.StyleBox"/> at <c>name</c> if the theme has <c>node_type</c>.</para>
        /// <para>Valid <c>name</c>s may be found using <see cref="Godot.Theme.GetStyleboxList"/>. Valid <c>node_type</c>s may be found using <see cref="Godot.Theme.GetStyleboxTypes"/>.</para>
        /// </summary>
        [GodotMethod("get_stylebox")]
        public StyleBox GetStylebox(string name, string nodeType)
        {
            return NativeCalls.godot_icall_2_312(method_bind_8, Object.GetPtr(this), name, nodeType);
        }
        ...
        /// <summary>
        /// <para>Returns <c>true</c> if <see cref="Godot.StyleBox"/> with <c>name</c> is in <c>node_type</c>.</para>
        /// <para>Returns <c>false</c> if the theme does not have <c>node_type</c>.</para>
        /// </summary>
        [GodotMethod("has_stylebox")]
        public bool HasStylebox(string name, string nodeType)
        {
            return NativeCalls.godot_icall_2_117(method_bind_9, Object.GetPtr(this), name, nodeType);
        }
        ...
        /// <summary>
        /// <para>Renames <see cref="Godot.StyleBox"/> at <c>old_name</c> to <c>name</c> if the theme has <c>node_type</c>. If <c>name</c> is already taken, this method fails.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Clears <see cref="Godot.StyleBox"/> at <c>name</c> if the theme has <c>node_type</c>.</para>
        /// </summary>
        [GodotMethod("clear_stylebox")]
        public void ClearStylebox(string name, string nodeType)
        {
            NativeCalls.godot_icall_2_108(method_bind_11, Object.GetPtr(this), name, nodeType);
        }
        ...
        /// <summary>
        /// <para>Returns all the <see cref="Godot.StyleBox"/>s as a <see cref="string"/> filled with each <see cref="Godot.StyleBox"/>'s name, for use in <see cref="Godot.Theme.GetStylebox"/>, if the theme has <c>node_type</c>.</para>
        /// <para>Valid <c>node_type</c>s may be found using <see cref="Godot.Theme.GetStyleboxTypes"/>.</para>
        /// </summary>
        [GodotMethod("get_stylebox_list")]
        public string[] GetStyleboxList(string nodeType)
        {
            return NativeCalls.godot_icall_1_303(method_bind_12, Object.GetPtr(this), nodeType);
        }
        ...
        {
            return NativeCalls.godot_icall_0_120(method_bind_13, Object.GetPtr(this));
        }
        ...
        /// <summary>
        /// <para>Sets the theme's <see cref="Godot.Font"/> to <c>font</c> at <c>name</c> in <c>node_type</c>.</para>
        /// <para>Creates <c>node_type</c> if the theme does not have it.</para>
        /// </summary>
        [GodotMethod("set_font")]
        public void SetFont(string name, string nodeType, Font font)
        {
            NativeCalls.godot_icall_3_118(method_bind_14, Object.GetPtr(this), name, nodeType, Object.GetPtr(font));
        }
        ...
        /// <summary>
        /// <para>Returns the <see cref="Godot.Font"/> at <c>name</c> if the theme has <c>node_type</c>.</para>
        /// </summary>
        [GodotMethod("get_font")]
        public Font GetFont(string name, string nodeType)
        {
            return NativeCalls.godot_icall_2_313(method_bind_15, Object.GetPtr(this), name, nodeType);
        }
        ...
        /// <summary>
        /// <para>Returns <c>true</c> if <see cref="Godot.Font"/> with <c>name</c> is in <c>node_type</c>.</para>
        /// <para>Returns <c>false</c> if the theme does not have <c>node_type</c>.</para>
        /// </summary>
        [GodotMethod("has_font")]
        public bool HasFont(string name, string nodeType)
        {
            return NativeCalls.godot_icall_2_117(method_bind_16, Object.GetPtr(this), name, nodeType);
        }
        ...
        /// <summary>
        /// <para>Renames the <see cref="Godot.Font"/> at <c>old_name</c> to <c>name</c> if the theme has <c>node_type</c>. If <c>name</c> is already taken, this method fails.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Clears the <see cref="Godot.Font"/> at <c>name</c> if the theme has <c>node_type</c>.</para>
        /// </summary>
        [GodotMethod("clear_font")]
        public void ClearFont(string name, string nodeType)
        {
            NativeCalls.godot_icall_2_108(method_bind_18, Object.GetPtr(this), name, nodeType);
        }
        ...
        /// <summary>
        /// <para>Returns all the <see cref="Godot.Font"/>s as a <see cref="string"/> filled with each <see cref="Godot.Font"/>'s name, for use in <see cref="Godot.Theme.GetFont"/>, if the theme has <c>node_type</c>.</para>
        /// </summary>
        [GodotMethod("get_font_list")]
        public string[] GetFontList(string nodeType)
        {
            return NativeCalls.godot_icall_1_303(method_bind_19, Object.GetPtr(this), nodeType);
        }
        ...
        {
            return NativeCalls.godot_icall_0_120(method_bind_20, Object.GetPtr(this));
        }
        ...
        /// <summary>
        /// <para>Sets the theme's <see cref="Godot.Color"/> to <c>color</c> at <c>name</c> in <c>node_type</c>.</para>
        /// <para>Creates <c>node_type</c> if the theme does not have it.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Returns the <see cref="Godot.Color"/> at <c>name</c> if the theme has <c>node_type</c>.</para>
        /// </summary>
        [GodotMethod("get_color")]
        public Color GetColor(string name, string nodeType)
        {
            NativeCalls.godot_icall_2_314(method_bind_22, Object.GetPtr(this), name, nodeType, out Color argRet); return (Color)argRet;
        }
        ...
        /// <summary>
        /// <para>Returns <c>true</c> if <see cref="Godot.Color"/> with <c>name</c> is in <c>node_type</c>.</para>
        /// <para>Returns <c>false</c> if the theme does not have <c>node_type</c>.</para>
        /// </summary>
        [GodotMethod("has_color")]
        public bool HasColor(string name, string nodeType)
        {
            return NativeCalls.godot_icall_2_117(method_bind_23, Object.GetPtr(this), name, nodeType);
        }
        ...
        /// <summary>
        /// <para>Renames the <see cref="Godot.Color"/> at <c>old_name</c> to <c>name</c> if the theme has <c>node_type</c>. If <c>name</c> is already taken, this method fails.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Clears the <see cref="Godot.Color"/> at <c>name</c> if the theme has <c>node_type</c>.</para>
        /// </summary>
        [GodotMethod("clear_color")]
        public void ClearColor(string name, string nodeType)
        {
            NativeCalls.godot_icall_2_108(method_bind_25, Object.GetPtr(this), name, nodeType);
        }
        ...
        /// <summary>
        /// <para>Returns all the <see cref="Godot.Color"/>s as a <see cref="string"/> filled with each <see cref="Godot.Color"/>'s name, for use in <see cref="Godot.Theme.GetColor"/>, if the theme has <c>node_type</c>.</para>
        /// </summary>
        [GodotMethod("get_color_list")]
        public string[] GetColorList(string nodeType)
        {
            return NativeCalls.godot_icall_1_303(method_bind_26, Object.GetPtr(this), nodeType);
        }
        ...
        {
            return NativeCalls.godot_icall_0_120(method_bind_27, Object.GetPtr(this));
        }
        ...
        public int GetConstant(string name, string nodeType)
        {
            return NativeCalls.godot_icall_2_315(method_bind_29, Object.GetPtr(this), name, nodeType);
        }
        ...
        public bool HasConstant(string name, string nodeType)
        {
            return NativeCalls.godot_icall_2_117(method_bind_30, Object.GetPtr(this), name, nodeType);
        }
        ...
        /// <summary>
        /// <para>Renames the constant at <c>old_name</c> to <c>name</c> if the theme has <c>node_type</c>. If <c>name</c> is already taken, this method fails.</para>
        /// </summary>
        ...
        public void ClearConstant(string name, string nodeType)
        {
            NativeCalls.godot_icall_2_108(method_bind_32, Object.GetPtr(this), name, nodeType);
        }
        ...
        /// <summary>
        /// <para>Returns all the constants as a <see cref="string"/> filled with each constant's name, for use in <see cref="Godot.Theme.GetConstant"/>, if the theme has <c>node_type</c>.</para>
        /// </summary>
        [GodotMethod("get_constant_list")]
        public string[] GetConstantList(string nodeType)
        {
            return NativeCalls.godot_icall_1_303(method_bind_33, Object.GetPtr(this), nodeType);
        }
        ...
        {
            return NativeCalls.godot_icall_0_120(method_bind_34, Object.GetPtr(this));
        }
        ...
        {
            return NativeCalls.godot_icall_0_316(method_bind_36, Object.GetPtr(this));
        }
        ...
        /// <summary>
        /// <para>Sets the theme item of <c>data_type</c> to <c>value</c> at <c>name</c> in <c>node_type</c>.</para>
        ...
        /// <summary>
        /// <para>Returns the theme item of <c>data_type</c> at <c>name</c> if the theme has <c>node_type</c>.</para>
        /// <para>Valid <c>name</c>s may be found using <see cref="Godot.Theme.GetThemeItemList"/> or a data type specific method. Valid <c>node_type</c>s may be found using <see cref="Godot.Theme.GetThemeItemTypes"/> or a data type specific method.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Returns <c>true</c> if a theme item of <c>data_type</c> with <c>name</c> is in <c>node_type</c>.</para>
        /// <para>Returns <c>false</c> if the theme does not have <c>node_type</c>.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Renames the theme item of <c>data_type</c> at <c>old_name</c> to <c>name</c> if the theme has <c>node_type</c>. If <c>name</c> is already taken, this method fails.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Clears the theme item of <c>data_type</c> at <c>name</c> if the theme has <c>node_type</c>.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Returns all the theme items of <c>data_type</c> as a <see cref="string"/> filled with each theme items's name, for use in <see cref="Godot.Theme.GetThemeItem"/> or a data type specific method, if the theme has <c>node_type</c>.</para>
        /// <para>Valid <c>node_type</c>s may be found using <see cref="Godot.Theme.GetThemeItemTypes"/> or a data type specific method.</para>
        /// </summary>
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private static IntPtr method_bind_45 = Object.godot_icall_Object_ClassDB_get_method(nativeName, "get_type_list");
        ...
        /// <para>Note: <c>node_type</c> has no effect and will be removed in future version.</para>
        /// </summary>
        [GodotMethod("get_type_list")]
        public string[] GetTypeList(string nodeType)
        {
            return NativeCalls.godot_icall_1_303(method_bind_45, Object.GetPtr(this), nodeType);
        }

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private static IntPtr method_bind_46 = Object.godot_icall_Object_ClassDB_get_method(nativeName, "copy_default_theme");
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private static IntPtr method_bind_47 = Object.godot_icall_Object_ClassDB_get_method(nativeName, "copy_theme");
        ...
        {
            NativeCalls.godot_icall_1_24(method_bind_47, Object.GetPtr(this), Object.GetPtr(other));
        }

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private static IntPtr method_bind_48 = Object.godot_icall_Object_ClassDB_get_method(nativeName, "merge_with");
        ...
        {
            NativeCalls.godot_icall_1_24(method_bind_48, Object.GetPtr(this), Object.GetPtr(other));
        }

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private static IntPtr method_bind_49 = Object.godot_icall_Object_ClassDB_get_method(nativeName, "clear");
