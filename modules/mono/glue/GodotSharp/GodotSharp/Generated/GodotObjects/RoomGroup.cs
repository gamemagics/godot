...
{
    /// <summary>
    /// <para>Although <see cref="Godot.Room"/> behaviour can be specified individually, sometimes it is faster and more convenient to write functionality for a group of rooms.</para>
