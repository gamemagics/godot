...
#pragma warning restore CS0618
        ...
        {
            NativeCalls.godot_icall_1_59(method_bind_0, Object.GetPtr(this), ref size);
        }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private static IntPtr method_bind_7 = Object.godot_icall_Object_ClassDB_get_method(nativeName, "_set_data");

        [Obsolete("_SetData is deprecated. Use the Data property instead.")]
        internal void _SetData(Godot.Collections.Dictionary arg0)
        {
            NativeCalls.godot_icall_1_213(method_bind_7, Object.GetPtr(this), arg0.GetPtr());
        }

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private static IntPtr method_bind_8 = Object.godot_icall_Object_ClassDB_get_method(nativeName, "_get_data");

        [Obsolete("_GetData is deprecated. Use the Data property instead.")]
        internal Godot.Collections.Dictionary _GetData()
        {
            return new Godot.Collections.Dictionary(NativeCalls.godot_icall_0_214(method_bind_8, Object.GetPtr(this)));
        }

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private static IntPtr method_bind_9 = Object.godot_icall_Object_ClassDB_get_method(nativeName, "grow_mask");
        ...
        {
            NativeCalls.godot_icall_2_215(method_bind_9, Object.GetPtr(this), pixels, ref rect);
        }

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private static IntPtr method_bind_10 = Object.godot_icall_Object_ClassDB_get_method(nativeName, "opaque_to_polygons");

        [GodotMethod("opaque_to_polygons")]
        public Godot.Collections.Array OpaqueToPolygons(Rect2 rect, float epsilon = 2f)
        {
            return new Godot.Collections.Array(NativeCalls.godot_icall_2_216(method_bind_10, Object.GetPtr(this), ref rect, epsilon));
        }
    }
}
