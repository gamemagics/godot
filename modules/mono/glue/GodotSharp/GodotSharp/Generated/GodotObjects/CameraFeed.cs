...
{
    /// <summary>
    /// <para>A camera feed gives you access to a single physical camera attached to your device. When enabled, Godot will start capturing frames from the camera which can then be used.</para>
...
#pragma warning restore CS0618
        ...
        {
            return (CameraFeed.FeedPosition)NativeCalls.godot_icall_0_251(method_bind_4, Object.GetPtr(this));
        }
        ...
        {
            NativeCalls.godot_icall_0_220(method_bind_5, Object.GetPtr(this), out Transform2D argRet); return (Transform2D)argRet;
        }
        ...
        {
            NativeCalls.godot_icall_1_219(method_bind_6, Object.GetPtr(this), ref transform);
        }
    }
}
