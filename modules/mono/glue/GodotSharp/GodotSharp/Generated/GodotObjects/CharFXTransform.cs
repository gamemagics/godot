...
namespace Godot
{
    ...
    {
        /// <summary>
        /// <para>The index of the current character (starting from 0). Setting this property won't affect drawing.</para>
        /// </summary>
...
#pragma warning restore CS0618
        ...
        {
            NativeCalls.godot_icall_1_277(method_bind_1, Object.GetPtr(this), index);
        }
        ...
        {
            NativeCalls.godot_icall_1_277(method_bind_3, Object.GetPtr(this), index);
        }
