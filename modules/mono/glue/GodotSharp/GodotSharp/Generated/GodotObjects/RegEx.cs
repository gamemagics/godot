...
namespace Godot
{
    ...
    public partial class RegEx : Reference
    {
        ...
        /// <summary>
        /// <para>Searches the text for the compiled pattern. Returns a <see cref="Godot.RegExMatch"/> container of the first matching result if found, otherwise <c>null</c>. The region to search within can be specified without modifying where the start and end anchor would be.</para>
        /// </summary>
        [GodotMethod("search")]
