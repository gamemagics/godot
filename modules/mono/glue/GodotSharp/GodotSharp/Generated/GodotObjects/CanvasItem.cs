...
namespace Godot
{
    ...
    /// <para>Any <see cref="Godot.CanvasItem"/> can draw. For this, <see cref="Godot.CanvasItem.Update"/> must be called, then <see cref="Godot.CanvasItem.NotificationDraw"/> will be received on idle time to request redraw. Because of this, canvas items don't need to be redrawn on every frame, improving the performance significantly. Several functions for drawing on the <see cref="Godot.CanvasItem"/> are provided (see <c>draw_*</c> functions). However, they can only be used inside the <see cref="Godot.Object._Notification"/>, signal or <see cref="Godot.CanvasItem._Draw"/> virtual functions.</para>
    ...
    {
        /// <summary>
        /// <para>The <see cref="Godot.CanvasItem"/>'s transform has changed. This notification is only received if enabled by <see cref="Godot.CanvasItem.SetNotifyTransform"/> or <see cref="Godot.CanvasItem.SetNotifyLocalTransform"/>.</para>
        /// </summary>
        public const int NotificationTransformChanged = 2000;
        /// <summary>
        /// <para>The <see cref="Godot.CanvasItem"/> is requested to draw.</para>
        /// </summary>
...
#pragma warning restore CS0618
        ...
        {
            return new RID(NativeCalls.godot_icall_0_247(method_bind_0, Object.GetPtr(this)));
        }
        ...
        /// <summary>
        /// <para>Returns <c>true</c> if the node is present in the <see cref="Godot.SceneTree"/>, its <see cref="Godot.CanvasItem.Visible"/> property is <c>true</c> and all its antecedents are also visible. If any antecedent is hidden, this node will not be visible in the scene tree.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Show the <see cref="Godot.CanvasItem"/> if it's currently hidden. For controls that inherit <see cref="Godot.Popup"/>, the correct way to make them visible is to call one of the multiple <c>popup*()</c> functions instead.</para>
        /// </summary>
        [GodotMethod("show")]
        public void Show()
        {
        ...
        /// <summary>
        /// <para>Hide the <see cref="Godot.CanvasItem"/> if it's currently visible.</para>
        /// </summary>
        [GodotMethod("hide")]
        public void Hide()
        {
        ...
        /// <summary>
        /// <para>Queue the <see cref="Godot.CanvasItem"/> for update. <see cref="Godot.CanvasItem.NotificationDraw"/> will be called on idle time to request redraw.</para>
        /// </summary>
        [GodotMethod("update")]
        public void Update()
        {
        ...
        /// <summary>
        /// <para>If <c>enable</c> is <c>true</c>, the node won't inherit its transform from parent canvas items.</para>
        /// </summary>
        ...
        {
            NativeCalls.godot_icall_5_254(method_bind_19, Object.GetPtr(this), ref from, ref to, ref color, width, antialiased);
        }
        ...
        {
            NativeCalls.godot_icall_4_255(method_bind_20, Object.GetPtr(this), points, ref color, width, antialiased);
        }
        ...
        {
            NativeCalls.godot_icall_4_256(method_bind_21, Object.GetPtr(this), points, colors, width, antialiased);
        }
        ...
        {
            NativeCalls.godot_icall_8_257(method_bind_22, Object.GetPtr(this), ref center, radius, startAngle, endAngle, pointCount, ref color, width, antialiased);
        }
        ...
        /// <para>Note: <c>width</c> and <c>antialiased</c> are currently not implemented and have no effect.</para>
        /// </summary>
        [GodotMethod("draw_multiline")]
        public void DrawMultiline(Vector2[] points, Color color, float width = 1f, bool antialiased = false)
        {
            NativeCalls.godot_icall_4_255(method_bind_23, Object.GetPtr(this), points, ref color, width, antialiased);
        }
        ...
        {
            NativeCalls.godot_icall_4_256(method_bind_24, Object.GetPtr(this), points, colors, width, antialiased);
        }
        ...
        /// <summary>
        /// <para>Draws a rectangle. If <c>filled</c> is <c>true</c>, the rectangle will be filled with the <c>color</c> specified. If <c>filled</c> is <c>false</c>, the rectangle will be drawn as a stroke with the <c>color</c> and <c>width</c> specified. If <c>antialiased</c> is <c>true</c>, the lines will be antialiased.</para>
        ...
        {
            NativeCalls.godot_icall_5_258(method_bind_25, Object.GetPtr(this), ref rect, ref color, filled, width, antialiased);
        }
        ...
        {
            NativeCalls.godot_icall_3_259(method_bind_26, Object.GetPtr(this), ref position, radius, ref color);
        }
        ...
        public void DrawTexture(Texture texture, Vector2 position, Nullable<Color> modulate = null, Texture normalMap = null)
        {
            ...
            NativeCalls.godot_icall_4_260(method_bind_27, Object.GetPtr(this), Object.GetPtr(texture), ref position, ref modulate_in, Object.GetPtr(normalMap));
        }
        ...
        {
            Color modulate_in = modulate.HasValue ? modulate.Value : new Color(1, 1, 1, 1);
            NativeCalls.godot_icall_6_261(method_bind_28, Object.GetPtr(this), Object.GetPtr(texture), ref rect, tile, ref modulate_in, transpose, Object.GetPtr(normalMap));
        }
        ...
        {
            Color modulate_in = modulate.HasValue ? modulate.Value : new Color(1, 1, 1, 1);
            NativeCalls.godot_icall_7_262(method_bind_29, Object.GetPtr(this), Object.GetPtr(texture), ref rect, ref srcRect, ref modulate_in, transpose, Object.GetPtr(normalMap), clipUv);
        }
        ...
        {
            NativeCalls.godot_icall_2_263(method_bind_30, Object.GetPtr(this), Object.GetPtr(styleBox), ref rect);
        }
        ...
        {
            NativeCalls.godot_icall_6_264(method_bind_31, Object.GetPtr(this), points, colors, uvs, Object.GetPtr(texture), width, Object.GetPtr(normalMap));
        }
        ...
        public void DrawPolygon(Vector2[] points, Color[] colors, Vector2[] uvs = null, Texture texture = null, Texture normalMap = null, bool antialiased = false)
        {
            ...
            NativeCalls.godot_icall_6_265(method_bind_32, Object.GetPtr(this), points, colors, uvs_in, Object.GetPtr(texture), Object.GetPtr(normalMap), antialiased);
        }
        ...
        {
            Vector2[] uvs_in = uvs != null ? uvs : Array.Empty<Vector2>();
            NativeCalls.godot_icall_6_266(method_bind_33, Object.GetPtr(this), points, ref color, uvs_in, Object.GetPtr(texture), Object.GetPtr(normalMap), antialiased);
        }
        ...
        {
            Color modulate_in = modulate.HasValue ? modulate.Value : new Color(1, 1, 1, 1);
            NativeCalls.godot_icall_5_267(method_bind_34, Object.GetPtr(this), Object.GetPtr(font), ref position, text, ref modulate_in, clipW);
        }
        ...
        {
            Color modulate_in = modulate.HasValue ? modulate.Value : new Color(1, 1, 1, 1);
            return NativeCalls.godot_icall_5_268(method_bind_35, Object.GetPtr(this), Object.GetPtr(font), ref position, @char, next, ref modulate_in);
        }
        ...
        public void DrawMesh(Mesh mesh, Texture texture, Texture normalMap = null, Nullable<Transform2D> transform = null, Nullable<Color> modulate = null)
        {
            ...
            Color modulate_in = modulate.HasValue ? modulate.Value : new Color(1, 1, 1, 1);
            NativeCalls.godot_icall_5_269(method_bind_36, Object.GetPtr(this), Object.GetPtr(mesh), Object.GetPtr(texture), Object.GetPtr(normalMap), ref transform_in, ref modulate_in);
        }
        ...
        {
            NativeCalls.godot_icall_3_270(method_bind_37, Object.GetPtr(this), Object.GetPtr(multimesh), Object.GetPtr(texture), Object.GetPtr(normalMap));
        }
        ...
        {
            NativeCalls.godot_icall_3_271(method_bind_38, Object.GetPtr(this), ref position, rotation, ref scale);
        }
        ...
        {
            NativeCalls.godot_icall_1_219(method_bind_39, Object.GetPtr(this), ref xform);
        }
        ...
        {
            NativeCalls.godot_icall_0_220(method_bind_40, Object.GetPtr(this), out Transform2D argRet); return (Transform2D)argRet;
        }
        ...
        {
            NativeCalls.godot_icall_0_220(method_bind_41, Object.GetPtr(this), out Transform2D argRet); return (Transform2D)argRet;
        }
        ...
        {
            NativeCalls.godot_icall_0_220(method_bind_42, Object.GetPtr(this), out Transform2D argRet); return (Transform2D)argRet;
        }
        ...
        {
            NativeCalls.godot_icall_0_220(method_bind_43, Object.GetPtr(this), out Transform2D argRet); return (Transform2D)argRet;
        }
        ...
        {
            NativeCalls.godot_icall_0_164(method_bind_44, Object.GetPtr(this), out Rect2 argRet); return (Rect2)argRet;
        }
        ...
        {
            NativeCalls.godot_icall_0_220(method_bind_45, Object.GetPtr(this), out Transform2D argRet); return (Transform2D)argRet;
        }
        ...
        {
            return new RID(NativeCalls.godot_icall_0_247(method_bind_48, Object.GetPtr(this)));
        }
        ...
        {
            return NativeCalls.godot_icall_0_272(method_bind_49, Object.GetPtr(this));
        }
        ...
        {
            return NativeCalls.godot_icall_0_273(method_bind_51, Object.GetPtr(this));
        }
        ...
        {
            NativeCalls.godot_icall_1_49(method_bind_59, Object.GetPtr(this), ref screenPoint, out Vector2 argRet); return (Vector2)argRet;
        }
        ...
        {
            return NativeCalls.godot_icall_1_274(method_bind_60, Object.GetPtr(this), Object.GetPtr(@event));
        }
    }
}
